    ...
    return (
        <div id='openHouse' className="max-w-[790px] mx-auto bg-white border border-gray-300">
            <div className="bg-green-800 text-white flex py-4 px-10 justify-between">
                ...
                <h2 className="text-lg">{data?._id}</h2> {/* Updated to use _id for MongoDB document ID */}
            </div>
            ...
            <div className='p-8 pt-0'>
                <div className="flex justify-between mt-4">
                    ...
                    <div>
                        ...
                        <p>1234 Main St, Bay Area, CA 12345</p> {/* companyAddress placeholder */}
                ...
                <div className="flex justify-between gap-4">
                    <div>
                        ...
                        <p>Zone: {data.requiredZone.name} - {data.requiredZone.text}</p>
                        <p>Time of First Event: {data.firstEventStartTime} - {data.firstEventEndTime}</p>
                        <p>Event Address (First Event):</p>
                        <p>{data.firstEventAddress.streetAddress} {data.firstEventAddress.streetAddress2}</p>
                        <p>{data.firstEventAddress.city}, {data.firstEventAddress.state} {data.firstEventAddress.postalCode}</p>
                    </div>
                ...
                <div>
                    ...
                    <p>Additional Sign Quantity: {data.additionalSignQuantity} ($5 per sign)</p>

          ...
          <div className="login-client w-[50vw] flex justify-center items-center py-10 gap-8">
            ...
            <div className="w-[90%] sm:w-3/4 lg:w-1/2 flex flex-col gap-4 py-8">
              ...
              <form onSubmit={handleSubmit} >
                <div className="mb-4">
                  <label className="block text-sm font-semibold text-[#101010]">Email</label>
                  <input
                    type="tel"
                ...
                <div className="mb-4">
                  <label className="block text-sm font-semibold text-[#101010]">Password</label>
                  <input
                    type="password"
                    className="mt-1 block w-full p-2 border border-gray-300 bg-[#FCFDFE] rounded-md shadow-sm "
                ...
                <button
                  type="submit"
                  className="w-full py-2 px-4 bg-[#4C9A2A] text-white font-semibold rounded-md shadow-sm hover:bg-gray-800"
                >
                  Log In
                </button>
              </form>
